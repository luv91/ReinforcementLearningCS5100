...
# the code below is same as: #https://github.com/openai/gym/blob/master/gym/envs/box2d/lunar_lander.py
# but takenn from: 
#Below code taken from : # https://github.com/rogerxcn/lunar_lander_project/blob/master/lunar_lander.py
