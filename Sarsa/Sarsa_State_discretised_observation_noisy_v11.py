...
for i in range(num_episodes):
    ...
    ds = state_extractor(observation)
    ...
    for each_time_step in range(num_timesteps):
        ...
        current_key = making_key_for_Q_hashmap(observation, a)
...
plt.plot(x, y, label='Naive Sarsa reward_10Kepisodes_V4_LessStateSpace_withUCBPolicyExtractor')
plt.savefig("naive_sarsa_reward_10Kepisodes_V4_LessStateSpace_withUCBPolicyExtractor.png")
...
np.savetxt("naive_sarsa_reward_10Kepisodes_V4_LessStateSpace_withNoisyObservations_v24.txt", y1)
# =============================================================================
